...
if (!function_exists('isUserFavourite')) {
    function isUserFavourite($shop_owner_id, $favourite_user_id)
    {
        $model = new \App\Models\ProfileModel();
        return $model->isUserFavourite($shop_owner_id, $favourite_user_id);
    }
}
...
if (!function_exists('is_shop_vacation')) {
    function isShopVacation($shop_id)
    {
        $model = new \App\Models\AuthModel();
        return $model->isShopVacation($shop_id);
    }
}

//get badge picture
if (!function_exists('getBadgePicture')) {
    function getBadgePicture($badgeName)
    {
        return base_url('assets/img/badges/'.$badgeName.'.png');
    }
}

//get badge names
if (!function_exists('getBadgeNames')) {
    function getBadgeNames()
    {
        $model = new \App\Models\SettingsModel();
        return $model->getBadgeNames();
    }
}

//check badge awarded for user
if (!function_exists('isBadgeAwarded')) {
    function isBadgeAwarded($userId, $badgeId)
    {
        $model = new \App\Models\BadgeModel();
        return $model->isBadgeAwarded($userId, $badgeId);
    }
}
//check whether user can award top seller badge or not
if (!function_exists('checkUserCanAwardTopSellerBadge')) {
    function checkUserCanAwardTopSellerBadge($userId)
    {
        $model = new \App\Models\AuthModel();
        return $model->checkUserCanAwardTopSellerBadge($userId);
    }
}

//check whether user can award top seller badge or not
if (!function_exists('checkUserCanAwardRatingBadge')) {
    function checkUserCanAwardRatingBadge($userId)
    {
        $model = new \App\Models\AuthModel();
        return $model->checkUserCanAwardRatingBadge($userId);
    }
}

//check whether user can award quick reply badge or not
if (!function_exists('checkUserCanAwardQuickReplyBadge')) {
    function checkUserCanAwardQuickReplyBadge($userId)
    {
        $model = new \App\Models\AuthModel();
        return $model->checkUserCanAwardQuickReplyBadge($userId);
    }
}

//check whether user can award quick shipping badge or not
if (!function_exists('checkUserCanAwardQuickShippingBadge')) {
    function checkUserCanAwardQuickShippingBadge($userId)
    {
        $model = new \App\Models\AuthModel();
        return $model->checkUserCanAwardQuickShippingBadge($userId);
    }
}

//check whether shipping tracking number set or not
if (!function_exists('isShippingTrackingNumberSet')) {
    function isShippingTrackingNumberSet($order_id)
    {
        $model = new \App\Models\OrderModel();
        return $model->isShippingTrackingNumberSet($order_id);
    }
}
...
if (!function_exists('getAdminUser')) {
    ...
    {
        $model = new \App\Models\AuthModel();
        return $model->getAdminUser();
    }
}

//is message exist from buyer to seller
if (!function_exists('isExistMessageFromBuyerToSeller')) {
    function isExistMessageFromBuyerToSeller($buyerId, $sellerId)
    {
        $model = new \App\Models\CartModel();
        return $model->isExistMessageFromBuyerToSeller($buyerId,$sellerId);
    }
}

//get message from buyer to seller
if (!function_exists('getMessageFromBuyerToSeller')) {
    function getMessageFromBuyerToSeller($buyerId, $sellerId)
    {
        $model = new \App\Models\CartModel();
        return $model->getMessageFromBuyerToSeller($buyerId,$sellerId);
    }
}

//get messages by seller id
if (!function_exists('getMessagesBySellerId')) {
    function getMessagesBySellerId($sellerId)
    {
        $model = new \App\Models\CartModel();
        return $model->getMessagesBySellerId($sellerId);
    }
}

//get all membership plans
if (!function_exists('getAllMembershipTitles')) {
    function getAllMembershipTitles()
    {
        $model = new \App\Models\MembershipModel();
        return $model->getAllMembershipTitles();
    }
}

//calculate transaction fee
if (!function_exists('calculateTransactionFee')) {
    function calculateTransactionFee($payAmount)
    {
        if($payAmount < 100){
            return 1;
        }else{
            return $payAmount * 4 / 100;
        }
    }
}
