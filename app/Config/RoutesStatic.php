...
$routes->get('test-url', 'TestController::test');
...
//profile
//==============================favourite===================================//
$routes->post('add-remove-favourite-user-post','ProfileController::addRemoveFavouriteUserPost');
//==============================favourite===================================//
...
//badge
$routes->post('add-remove-badge', 'BadgeController::awardBadgePost');

//===============================vacation=======================//
$routes->post('enable-disable-vacation-mode' , 'DashboardController::enableDisableVacationMode');
//===============================vacation=======================//

//===============================leave message for seller======================//
$routes->post('leave-message-to-seller' , 'CartController::leaveMessageToSeller');
$routes->post('delete-message-from-buyer' , 'CartController::deleteMessageFromBuyer');
