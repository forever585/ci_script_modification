...
$routes->get($rtAdmin . '/listing-fees', 'EarningsController::getListingFees');
...
$routes->get($rtAdmin . '/set-listing-fee-paid/(:num)', 'AdminController::setSellerListingFeePaid/$1');
/*
 * --------------------------------------------------------------------
 * Dynamic Routes
 * --------------------------------------------------------------------
...
if (!empty($languages)) {
    foreach ($languages as $language) {
        ...
        //=========================favourite============================
        $routes->get($key . $csrt->favourite_shops . '/(:any)','ProfileController::favouriteShops/$1');
        //============================================================
        ...
        $routes->get($key . 'invoice-listing-fee/(:num)', 'HomeController::invoiceListingFee/$1');
        //refund
        ...
        $routes->get($key . $csrt->dashboard . '/' . $csrt->listing_fees, 'DashboardController::listingFees');
        ...
        //help center  DashboardController::enableDisableVacationMode/$1
