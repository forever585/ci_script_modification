...
class FeeAdminModel extends BaseModel
{
    protected $builder;
    ...
    public function getListingFeesCount()
    {
        return $this->builder->countAllResults();
    }

    //get listing fees
    public function getListingFeesPaginated($perPage, $offset)
    {
        ...
        return $this->builder->where("product_details.lang_id",selectedLangId())->select("listing_fees.*, users.username, product_details.title")->orderBy('listing_fees.created_at DESC')->limit($perPage, $offset)->get()->getResult();
    }
