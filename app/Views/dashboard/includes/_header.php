            ...
            <nav class="navbar navbar-static-top">
                <div class="inline-flex">
                    <a href="#" class="sidebar-toggle" data-toggle="push-menu" role="button">
                        ...
                        <form action="<?= generateUrl('enable_disable_vacation_mode'); ?>" method="post" class="form-inline inline-flex align-items-center">
                            <?= csrf_field(); ?>
                            <input name="shop_id" type="hidden" value="<?= user()->id?>"/>
                            <input name="state" type="hidden" value="<?= isShopVacation(user()->id) ? 0 : 1 ?>"/>
                            <input type="hidden" name="back_url" value="<?= generateDashUrl('/'); ?>">
                            <?php if (isShopVacation(user()->id)): ?>
                                <h5 class="margin-0 color-blue">Vacation Mode : Enabled</h5>
                                <p class="margin-0">
                                    <button type="submit" class="btn btn-sm btn-primary margin-bottom-0 margin-left-10 btn-vacation"><i class="fa fa-ban"></i><?= " Disable It"; ?></button>
                                </p>
                            <?php else: ?>
                                <h5 class="margin-0 color-blue">Vacation Mode : Disabled</h5>
                                <p class="margin-0">
                                    <button type="submit" class="btn btn-sm btn-success margin-bottom-0 margin-left-10 btn-vacation"><i class="icon-check"></i><?= " Enable It" ?></button>
                                </p>
                            <?php endif; ?>
                        </form>
                    <div class="navbar-custom-menu dashboard-nav-menu">
                ...
                <?php if (isVendor()): ?>
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <?php if ($baseVars->isSaleActive): ?>
                            ...
                            <li class="nav-earnings">
                                <a href="<?= generateDashUrl('listing-fees'); ?>">
