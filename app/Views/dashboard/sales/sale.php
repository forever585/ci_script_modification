                        ...
                        if (!empty($orderProducts)):
                            foreach ($orderProducts as $item):
                                if ($item->seller_id == user()->id):
                                    $giftFeeTotal += $item->gift_wrapping_fee * $item->gift_quantity;
                                    $saleSubtotal += $item->product_unit_price * $item->product_quantity;
                                    $saleSubtotal += $giftFeeTotal;
                                    $saleVat += $item->product_vat;
                                    $saleShipping = $item->seller_shipping_cost;
                                    $saleTotal += $item->product_total_price - $giftFeeTotal; ?>
                                    <tr>
                                        <td style="width: 50%">
                                            <div class="table-item-product">
                                                ...
                                                <div class="right">
                                                    ...
                                                    <?php if($item->gift_wrapping_fee != 0 && $item->gift_quantity != 0):?>
                                                        <p><span class="span-product-dtl-table"><?= "Gift Wrapping Fee"; ?>:</span><?= priceFormatted($item->gift_wrapping_fee, $item->product_currency); ?></p>
                                                        <p><span class="span-product-dtl-table"><?= "Gift Quantity"; ?>:</span><?= $item->gift_quantity; ?></p>
                                                    <?php endif;?>
                                                    <?php if (!empty($item->product_vat)): ?>
                                                        ...
                                                        <p><span class="span-product-dtl-table"><?= trans("total"); ?>:</span><?= priceFormatted($item->product_total_gift_contained_price, $item->product_currency); ?></p>
                                                    <?php else: ?>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="order-total">
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-xs-8 col-left">
                            <?= "Total Gift Wrapping Fee:"; ?>
                        </div>
                        <div class="col-sm-4 col-xs-4 col-right">
                            <strong><?= priceFormatted($order->total_gift_wrapping_fee, $order->price_currency); ?></strong>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-xs-6 col-right">
                            <strong><?= priceFormatted($order->price_total, $order->price_currency); ?></strong>
                        </div>
                    </div>
                </div>
            </div>
