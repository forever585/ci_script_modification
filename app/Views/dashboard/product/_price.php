            ...
            <div id="price_input_container" class="form-group">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3">
                        <div class="row align-items-center">
                            <div class="col-sm-12">
                                <label class="font-600"><?= "Gift Wrapping Fee"; ?></label>
                                <div id="gift_fee_input_container" class="<?= $product->gift_wrapping_fee == 0 ? 'display-none' : ''; ?>">
                                    <div class="input-group">
                                        <span class="input-group-addon">$</span>
                                        <input type="number" name="gift_wrapping_fee" id="input_gift_wrapping_fee" aria-describedby="basic-addon-vat" class="form-control form-input" value="<?= $product->gift_wrapping_fee; ?>" min="0" max="100" step="0.01">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 m-t-10">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" name="gift_wrapping_fee_enabled" id="checkbox_gift_wrapping_fee_enabled" <?= $product->gift_wrapping_fee == 0 ? '' : 'checked'; ?>>
                                    <label for="checkbox_gift_wrapping_fee_enabled" class="custom-control-label"><?= "Enable Gift Wrapping"; ?></label>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-12 m-t-30">
                        ...
                        <p class="calculated-price">
                            ...
                            <?php endif; ?>
                            <b id="gift_wrapping_fee_label" class="<?= $product->gift_wrapping_fee == 0 ? 'display-none' : ''; ?>">+&nbsp;&nbsp;&nbsp;<?= "Gift Wrapping Fee"; ?></b>
...
<script>
    ...
    $('#checkbox_gift_wrapping_fee_enabled').change(function () {
        if (this.checked) {
            $("#gift_fee_input_container").show();
            $("#gift_wrapping_fee_label").show();
        } else {
            $('#gift_wrapping_fee').val("0");
            $("#gift_fee_input_container").hide();
            $("#gift_wrapping_fee_label").hide();
            $('#checkbox_gift_wrapping_fee_enabled').change();
        }
    });
</script>
