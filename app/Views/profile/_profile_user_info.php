<div class="row-custom">
    <div class="profile-details">
        ...
        <div class="right">
            <div class="row-custom row-profile-username profile-info-header-right">
                <h1 class="username">
                    ...
                    <?php if (authCheck()):
                        if (user()->id != $user->id): ?>
                            ...
                            <form action="<?= base_url('add-remove-favourite-user-post'); ?>" method="post" class="form-inline">
                                <?= csrf_field(); ?>
                                <input type="hidden" name="shop_owner_id" value="<?= $user->id; ?>">
                                <input type="hidden" name="favourite_user_id" value="<?= user()->id; ?>">
                                <input type="hidden" name="back_url" value="<?= getCurrentUrl(); ?>">
                                <?php if (isUserFavourite($user->id, user()->id)): ?>
                                    <p>
