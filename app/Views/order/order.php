                            ...
                            <div class="row shipping-container">
                                <div class="col-md-12 col-lg-6 m-b-sm-15">
                                    <div class="order-address-box">
                                        ...
                                        <div class="row shipping-row-item">
                                            ...
                                            <div class="col-7"><?= $shipping->sFirstName ? esc($shipping->sFirstName) : ''; ?></div>
                                        </div>
                                        <div class="row shipping-row-item">
                                            <div class="col-5"><?= trans("last_name"); ?></div>
                                            <div class="col-7"><?= $shipping->sLastName ? esc($shipping->sLastName) : ''; ?></div>
                                        </div>
                                        <div class="row shipping-row-item">
                                            <div class="col-5"><?= trans("email"); ?></div>
                                            <div class="col-7"><?= $shipping->sEmail ? esc($shipping->sEmail) : ''; ?></div>
                                        </div>
                                        <div class="row shipping-row-item">
                                            <div class="col-5"><?= trans("phone_number"); ?></div>
                                            <div class="col-7"><?= $shipping->sPhoneNumber ? esc($shipping->sPhoneNumber) : ''; ?></div>
                                        </div>
                                        <div class="row shipping-row-item">
                                            <div class="col-5"><?= trans("address"); ?></div>
                                            <div class="col-7"><?= $shipping->sAddress ? esc($shipping->sAddress) : ''; ?></div>
                                        </div>
                                        <div class="row shipping-row-item">
                                            <div class="col-5"><?= trans("country"); ?></div>
                                            <div class="col-7"><?= $shipping->sCountry ? esc($shipping->sCountry) : ''; ?></div>
                                        </div>
                                        <div class="row shipping-row-item">
                                            <div class="col-5"><?= trans("state"); ?></div>
                                            <div class="col-7"><?= $shipping->sState ? esc($shipping->sState) : ''; ?></div>
                                        </div>
                                        <div class="row shipping-row-item">
                                            <div class="col-5"><?= trans("city"); ?></div>
                                            <div class="col-7"><?= $shipping->sCity ? esc($shipping->sCity) : ''; ?></div>
                                        </div>
                                        <div class="row shipping-row-item mb-0">
                                            <div class="col-5"><?= trans("zip_code"); ?></div>
                                            <div class="col-7"><?= $shipping->sZipCode ? esc($shipping->sZipCode) : ''; ?></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12 col-lg-6">
                                    <div class="order-address-box">
                                        ...
                                        <div class="row shipping-row-item">
                                            <div class="col-5"><?= trans("first_name"); ?></div>
                                            <div class="col-7"><?= $shipping->bFirstName ? esc($shipping->bFirstName) : ''; ?></div>
                                        </div>
                                        <div class="row shipping-row-item">
                                            <div class="col-5"><?= trans("last_name"); ?></div>
                                            <div class="col-7"><?= $shipping->bLastName ? esc($shipping->bLastName) : ''; ?></div>
                                        </div>
                                        <div class="row shipping-row-item">
                                            <div class="col-5"><?= trans("email"); ?></div>
                                            <div class="col-7"><?= $shipping->bEmail ? esc($shipping->bEmail) : ''; ?></div>
                                        </div>
                                        <div class="row shipping-row-item">
                                            <div class="col-5"><?= trans("phone_number"); ?></div>
                                            <div class="col-7"><?= $shipping->bPhoneNumber ? esc($shipping->bPhoneNumber) : ''; ?></div>
                                        </div>
                                        <div class="row shipping-row-item">
                                            <div class="col-5"><?= trans("address"); ?></div>
                                            <div class="col-7"><?= $shipping->bAddress ? esc($shipping->bAddress) : ''; ?></div>
                                        </div>
                                        <div class="row shipping-row-item">
                                            <div class="col-5"><?= trans("country"); ?></div>
                                            <div class="col-7"><?= $shipping->bCountry ? esc($shipping->bCountry) : ''; ?></div>
                                        </div>
                                        <div class="row shipping-row-item">
                                            <div class="col-5"><?= trans("state"); ?></div>
                                            <div class="col-7"><?= $shipping->bState ? esc($shipping->bState) : ''; ?></div>
                                        </div>
                                        <div class="row shipping-row-item">
                                            <div class="col-5"><?= trans("city"); ?></div>
                                            <div class="col-7"><?= $shipping->bCity ? esc($shipping->bCity) : ''; ?></div>
                                        </div>
                                        <div class="row shipping-row-item mb-0">
                                            <div class="col-5"><?= trans("zip_code"); ?></div>
                                            <div class="col-7"><?= $shipping->bZipCode ? esc($shipping->bZipCode) : ''; ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <td style="width: 50%">
                                                        <div class="table-item-product">
                                                            ...
                                                            <div class="right">
                                                                ...
                                                                <?php if($item->gift_wrapping_fee != 0 && $item->gift_quantity != 0):?>
                                                                    <div class="m-b-5"><span class="span-product-dtl-table"><?= "Gift Wrapping Fee"; ?>:</span><?= priceFormatted($item->gift_wrapping_fee, $item->product_currency); ?></div>
                                                                    <div class="m-b-5"><span class="span-product-dtl-table"><?= "Gift Quantity"; ?>:</span><?= $item->gift_quantity; ?></div>
                                                                <?php endif;?>
                                                                <?php if (!empty($item->product_vat)): ?>
                                                                    ...
                                                                    <div class="m-b-5"><span class="span-product-dtl-table"><?= trans("total"); ?>:</span><?= priceFormatted($item->product_total_gift_contained_price, $item->product_currency); ?></div>
                                                                <?php else: ?>
                                                                    <div class="m-b-5"><span class="span-product-dtl-table"><?= trans("total"); ?>:</span><?= priceFormatted($item->product_total_gift_contained_price, $item->product_currency); ?></div>
                                                                <?php endif; ?>
                                                            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="order-total">
                                    ...
                                    <?php if (!empty($order->total_gift_wrapping_fee)): ?>
                                        <div class="row">
                                            <div class="col-6 col-left">
                                                <?= "Gift Wrapping Fee"; ?>
                                            </div>
                                            <div class="col-6 col-right">
                                                <strong class="font-600"><?= priceFormatted($order->total_gift_wrapping_fee, $order->price_currency); ?></strong>
                                            </div>
                                        </div>
                                    <?php endif; ?>
