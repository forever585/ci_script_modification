<div class="col-sm-12 col-lg-4 order-summary-container">
    ...
    <div class="right">
                        ...
                        <div class="item">
                            ...
                            <div class="item-right">
                                ...
                                <div class="list-item">
                                    ...
                                    <strong class="lbl-price"><?= priceDecimal($cartItem->total_gift_wrapping_fee, $cartItem->currency); ?></strong>
                                </div>
        ...
        <?php endif;
        if(!empty($cartTotal->total_gift_wrapping_fee)):?>
            <div class="row-custom m-b-10">
                <strong><?= "Total Gift Wrapping Fee"; ?><span class="float-right"><?= priceDecimal($cartTotal->total_gift_wrapping_fee, $cartTotal->currency); ?></span></strong>
            </div>
        <?php endif;
