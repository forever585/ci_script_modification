                        ...
                        <div class="row">
                                ...
                                <div class="left">
                                    ...
                                    <?php if (!empty($cartItems)):
                                        foreach ($cartItems as $cartItem):
                                            ...
                                            if (!empty($product) && $cartItem->no_gift_quantity > 0): ?>
                                                <div class="item">
                                                    ...
                                                    <div class="cart-item-details">
                                                        ...
                                                        <?php if ($cartItem->purchase_type != 'bidding'): ?>
                                                            <div class="list-item m-t-15">
                                                                ...
                                                                <strong class="lbl-price">
                                                                    <?= priceDecimal($cartItem->unit_no_gift_price, $cartItem->currency);
                                                        ...
                                                        <div class="list-item">
                                                            ...
                                                            <strong class="lbl-price"><?= priceDecimal($cartItem->total_no_gift_price, $cartItem->currency); ?></strong>
                                                        </div>
                                                        <?php if (!empty($product->vat_rate)): ?>
                                                            <div class="list-item">
                                                                <label><?= trans("vat"); ?>&nbsp;(<?= $product->vat_rate; ?>%):</label>
                                                                <strong class="lbl-price"><?= priceDecimal($cartItem->product_vat / $cartItem->quantity * $cartItem->no_gift_quantity, $cartItem->currency); ?></strong>
                                                            </div>
                                                        <?php endif; ?>
                                                    ...
                                                    <div class="cart-item-quantity-no-gift" data-is-gift="0">
                                                        <?php if ($cartItem->purchase_type == 'bidding'): ?>
                                                            <span><?= trans("quantity") . ': ' . $cartItem->no_gift_quantity; ?></span>
                                                        <?php else:
                                                            if ($product->listing_type != 'license_key' && $product->product_type != 'digital'):?>
                                                                <div class="number-spinner">
                                                                    <div class="input-group">
                                                                        <span class="input-group-btn">
                                                                            <button type="button" class="btn btn-default btn-spinner-minus no-gift" data-is-gift="0" data-cart-item-id="<?= $cartItem->cart_item_id; ?>" data-dir="dwn">-</button>
                                                                        </span>
                                                                        <input type="text" id="q-no-gift-<?= $cartItem->cart_item_id; ?>" class="form-control text-center"  data-is-gift="0" value="<?= $cartItem->no_gift_quantity; ?>" data-product-id="<?= $cartItem->product_id; ?>" data-cart-item-id="<?= $cartItem->cart_item_id; ?>">
                                                                        <span class="input-group-btn">
                                                                            <button type="button" class="btn btn-default btn-spinner-plus no-gift" data-is-gift="0" data-cart-item-id="<?= $cartItem->cart_item_id; ?>" data-dir="up">+</button>
                                                                        </span>
                                                                    </div>
                                                                </div>
                                                            <?php endif;
                                            ...
                                            <?php endif;?>
                                            <?php if (!empty($product) && $cartItem->gift_quantity > 0): ?>
                                                <div class="item">
                                                    <div class="cart-item-image">
                                                        <div class="img-cart-product">
                                                            <a href="<?= generateProductUrl($product); ?>">
                                                    ...
                                                    <div class="cart-item-details">
                                                        ...
                                                        <div class="list-item">
                                                            ...
                                                            <strong class="lbl-price"><?= "$".$cartItem->total_gift_wrapping_fee; ?></strong>
                                                        </div>
                                                        <div class="list-item">
                                                            <label><?= trans("total"); ?>:</label>
                                                            <strong class="lbl-price"><?= priceDecimal($cartItem->total_gift_price, $cartItem->currency); ?></strong>
                                                        </div>
                                                        <?php if (!empty($product->vat_rate)): ?>
                                                            <div class="list-item">
                                                                <label><?= trans("vat"); ?>&nbsp;(<?= $product->vat_rate; ?>%):</label>
                                                                <strong class="lbl-price"><?= priceDecimal($cartItem->product_vat / $cartItem->quantity * $cartItem->gift_quantity, $cartItem->currency); ?></strong>
                                                            </div>
                                                        <?php endif; ?>
                                                        <a href="javascript:void(0)" class="btn btn-sm btn-outline-gray btn-cart-remove" onclick="removeFromCart('<?= $cartItem->cart_item_id; ?>');"><i class="icon-close"></i> <?= trans("remove"); ?></a>
                                                    </div>
                                                    <div class="cart-item-quantity-gift">
                                                        <?php if ($cartItem->purchase_type == 'bidding'): ?>
                                                            <span><?= trans("quantity") . ': ' . $cartItem->gift_quantity; ?></span>
                                                        <?php else:
                                                            if ($product->listing_type != 'license_key' && $product->product_type != 'digital'):?>
                                                                <div class="number-spinner">
                                                                    <div class="input-group">
                                                                        <span class="input-group-btn">
                                                                            <button type="button" class="btn btn-default btn-spinner-minus gift" data-is-gift="1" data-cart-item-id="<?= $cartItem->cart_item_id; ?>" data-dir="dwn">-</button>
                                                                        </span>
                                                                        <input type="text" id="q-gift-<?= $cartItem->cart_item_id; ?>" class="form-control text-center"  data-is-gift="1" value="<?= $cartItem->gift_quantity; ?>" data-product-id="<?= $cartItem->product_id; ?>" data-cart-item-id="<?= $cartItem->cart_item_id; ?>">
                                                                        <span class="input-group-btn">
                                                                            <button type="button" class="btn btn-default btn-spinner-plus gift" data-is-gift="1" data-cart-item-id="<?= $cartItem->cart_item_id; ?>" data-dir="up">+</button>
                                                                        </span>
                                                                    </div>
                                                                </div>
                                                            <?php endif;
                            ...
                            <div class="col-sm-12 col-lg-4">
                                <div class="right">
                                    ...
                                    <?php if (!empty($cartTotal->total_gift_wrapping_fee)): ?>
                                    <div class="row-custom m-b-15">
                                        <strong><?= "Gift Wrapping Fee"; ?><span class="float-right"><?= priceDecimal($cartTotal->total_gift_wrapping_fee, $cartTotal->currency); ?></span></strong>
                                    </div>
                                    <?php endif;
                                    ...
                                    <?php foreach ($sellerIds as $sellerId):
                                        $data = [
                                                "id"=>$sellerId
                                        ];
                                        if($sellerId != null && authCheck())
                                            echo view('cart/message_for_seller',$data);
                                        ?>
                                    <?php endforeach;?>
                                </div>
                            </div>
