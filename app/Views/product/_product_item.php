...
<div class="product-item">
    <div class="row-custom<?= !empty($product->image_second) ? ' product-multiple-image' : ''; ?>">
        ...
        <div class="img-product-container">
            <?php if( !empty($user->is_vacation) && $user->is_vacation == 1) :?>
                <?= '<h5 class="span-vacation">On Vacation </h5>' ?>
            <?php endif;?>
            <?php if (!empty($isSlider)): ?>
                <a class="padding-top-20" href="<?= generateProductUrl($product); ?>">
            ...
            <div class="product-item-options">
                ...
                <?php if (($product->listing_type == 'sell_on_site' || $product->listing_type == 'bidding') && $product->is_free_product != 1):
                    ...
                    <?php else:
                        ...
                        if($user->is_vacation == 0 && $product->stock > 0):?>
