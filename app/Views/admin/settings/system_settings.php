        ...
        <div class="box box-primary">
            ...
            <form action="<?= base_url('AdminController/systemSettingsPost'); ?>" method="post">
                ...
                <div class="box-footer">
                    <button type="submit" name="submit" value="system_setting" class="btn btn-primary pull-right"><?= trans('save_changes'); ?></button>
                </div>
            </form>
        </div>
    </div>
...
<!--Fee Setting-->
    <div class="col-lg-6 col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><?= "Fee Setting"; ?></h3>
            </div>
            <form action="<?= base_url('AdminController/systemSettingsPost'); ?>" method="post">
                <?= csrf_field(); ?>
                <div class="box-body">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-12 col-xs-12 m-b-10">
                                <label><strong><?= "Enable/Disable Fees"; ?></strong></label>
                            </div>
                            <div class="col-sm-6 col-xs-12 col-option">
                                <input type="radio" name="is_fee_enable" value="1" id="physical_products_1" class="square-purple" <?= $generalSettings->is_fee_enable == 1 ? 'checked' : ''; ?>>
                                <label for="physical_products_1" class="option-label"><?= trans('enable'); ?></label>
                            </div>
                            <div class="col-sm-6 col-xs-12 col-option">
                                <input type="radio" name="is_fee_enable" value="0" id="physical_products_2" class="square-purple" <?= $generalSettings->is_fee_enable != 1 ? 'checked' : ''; ?>>
                                <label for="physical_products_2" class="option-label"><?= trans('disable'); ?></label>
                            </div>
                        </div>
                    </div>
                    <?php if($generalSettings->is_fee_enable == 1  ):?>
                        <div class="form-group">
                            <label><?= "Listing Fee "; ?>($)</label>
                            <input type="text" name="listing_fee" class="form-control" value="<?= empty($generalSettings->listing_fee) ? 5.25 : $generalSettings->listing_fee; ?>">
                        </div>
                    <?php endif;?>
                </div>
                <div class="box-footer">
                    <button type="submit" name="submit" value="fee_setting" class="btn btn-primary pull-right"><?= trans('save_changes'); ?></button>
                </div>
            </form>
        </div>
    </div>
