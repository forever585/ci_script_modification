...
<div class="row">
    ...
    <div class="col-sm-12 col-md-12 col-lg-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo "Badge"; ?></h3>
            </div>
            <form action="<?= base_url('AdminController/preferencesPost'); ?>" method="post">
                <?= csrf_field(); ?>
                <div class="box-body">
                    <!-- This is top-seller badge setting-->
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                <label>Top Seller Badge</label>
                            </div>
                            <div class="col-sm-12 col-xs-12 inline-flex align-items-center">
                                <div class="col-md-6 col-xs-6">
                                    <label for="min_top_seller_earn_2" class="float-right">Amount of Money Top Seller Have to Earn($):</label>
                                </div>
                                <div class="col-md-6 col-xs-6">
                                    <input type="number" class="form-control" id="min_top_seller_earn_2" name="min_top_seller_earn" placeholder="For Example: 2500" value="<?= $generalSettings->min_top_seller_earn; ?>" required="">
                                </div>
                            </div>
                        </div>
                    </div>
                    <!-- This is rating setting-->
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                            ...
                            <div class="col-sm-12 col-xs-12 inline-flex align-items-center">
                                <div class="col-md-6 col-xs-6">
                                    <label for="min_avg_rating_val_2" class="float-right">Minimum Average Value:</label>
                                </div>
                                <div class="col-md-6 col-xs-6">
                                    <input type="text" class="form-control" id="min_avg_rating_val_2" name="min_avg_rating_val" placeholder="For Example: 4.7" value="<?= $generalSettings->min_avg_rating_val; ?>" required="">
                                </div>
                            </div>
                            <div class="col-sm-12 col-xs-12 inline-flex align-items-center margin-top-10">
                                <div class="col-md-6 col-xs-6">
                                    <label for="min_num_of_reviews_2" class="float-right">Minimum Number of Reviews:</label>
                                </div>
                                <div class="col-md-6 col-xs-6">
                                    <input type="number" class="form-control" id="min_num_of_reviews_2" name="min_num_of_reviews" placeholder="For Example: 100" value="<?= $generalSettings->min_num_of_reviews; ?>" required="">
                                </div>
                            </div>
                        </div>
                    </div>
                    <!-- This is appreciation setting-->
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                            ...
                            <div class="col-sm-12 col-xs-12 inline-flex align-items-center">
                                <div class="col-md-6 col-xs-6">
                                    <label for="threshold_of_quick_reply_2" class="float-right">Minimum Interval To Gain This badge(hours):</label>
                                </div>
                                <div class="col-md-6 col-xs-6">
                                    <input type="number" class="form-control" id="threshold_of_quick_reply_2" name="threshold_of_quick_reply" placeholder="For Example: 4" value="<?= $generalSettings->threshold_of_quick_reply; ?>" required="">
                                </div>
                            </div>
                            <div class="col-sm-12 col-xs-12 inline-flex align-items-center margin-top-10">
                                <div class="col-md-6 col-xs-6">
                                    <label for="min_num_of_quick_reply_2" class="float-right">Minimum Number of Quick Reply Within Specific Hours:</label>
                                </div>
                                <div class="col-md-6 col-xs-6">
                                    <input type="number" class="form-control" id="min_num_of_quick_reply_2" name="min_num_of_quick_reply" placeholder="For Example: 2500" value="<?= $generalSettings->min_num_of_quick_reply; ?>" required="">
                                </div>
                            </div>
                        </div>
                    </div>

                    <!-- This is shipping badge setting-->
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                            ...
                            <div class="col-sm-12 col-xs-12 inline-flex align-items-center">
                                <div class="col-md-6 col-xs-6">
                                    <label for="threshold_of_quick_shipping_2" class="float-right">Minimum Interval To Gain This badge(hours):</label>
                                </div>
                                <div class="col-md-6 col-xs-6">
                                    <input type="number" class="form-control" id="threshold_of_quick_shipping_2" name="threshold_of_quick_shipping" placeholder="For Example: 1000" value="<?= $generalSettings->threshold_of_quick_shipping; ?>" required="">
                                </div>
                            </div>
                            <div class="col-sm-12 col-xs-12 inline-flex align-items-center margin-top-10">
                                <div class="col-md-6 col-xs-6">
                                    <label for="min_num_of_quick_shipping_2" class="float-right">Minimum Number of Quick Shipping:</label>
                                </div>
                                <div class="col-md-6 col-xs-6">
                                    <input type="number" class="form-control" id="min_num_of_quick_shipping_2" name="min_num_of_quick_shipping" placeholder="For Example: 4" value="<?= $generalSettings->min_num_of_quick_shipping; ?>" required="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="box-footer">
                    <button type="submit" name="submit" value="badge" class="btn btn-primary pull-right"><?= trans('save_changes'); ?></button>
                </div>
            </form>
        </div>
    </div>
