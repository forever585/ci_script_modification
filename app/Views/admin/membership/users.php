                                    ...
                                    <td>
                                        ...
                                        if ($showOptions): ?>
                                            <div class="dropdown">
                                                ...
                                                <ul style="min-width: 240px;" class="dropdown-menu options-dropdown">
                                                    <li>
                                                    ...
                                                    <?php if($userRole->is_vendor || $userRole->is_super_admin):
                                                        foreach (getBadgeNames() as $badgeName) :?>
                                                            <li>
                                                                <form action="<?= base_url('add-remove-badge'); ?>" method="post" class="form-inline">
                                                                    <?= csrf_field(); ?>
                                                                    <input type="hidden" name="user_id" value="<?= $user->id; ?>">
                                                                    <input type="hidden" name="badge_id" value="<?= $badgeName->id; ?>">
                                                                    <input type="hidden" name="back_url" value="<?= adminUrl('users') ?>">
                                                                    <input type="hidden" name="is_award" value="<?= (isBadgeAwarded($user->id, $badgeName->id) == "can_award" || isBadgeAwarded($user->id, $badgeName->id) == "removed_by_admin") ? 0 : 1;?>">
                                                                    <?php if(isBadgeAwarded($user->id, $badgeName->id) == "can_award" || isBadgeAwarded($user->id, $badgeName->id) == "removed_by_admin"):?>
																		<button href="javascript:void(0)">
                                                                            <i class="fa fa-plus-circle option-icon"></i><?= "Add ".$badgeName->badge_name." Badge"; ?>
                                                                        </button>
                                                                    <?php else:?>
                                                                        <button href="javascript:void(0)">
                                                                            <i class="fa fa-minus-circle option-icon"></i><?= "Remove ".$badgeName->badge_name." Badge"; ?>
                                                                        </button>
                                                                    <?php endif;?>
                                                                </form>
                                                            </li>
