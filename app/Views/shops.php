                                            ...
                                            <?php if (authCheck()): ?>
                                                <?php if ($shop->id != user()->id): ?>
                                                    <form action="<?= base_url('follow-unfollow-user-post'); ?>" method="post" class="form-inline">
                                                        ...
                                                        <input type="hidden" name="back_url" value="<?= generateUrl('shops') ?>">
                                                        <?php if (isUserFollows($shop->id, user()->id)): ?>
                                                            <p>
                                                                <button class="btn btn-md btn-outline-gray btn-shop"><i class="icon-user-minus"></i><?= trans("unfollow"); ?></button>
                                                            </p>
                                                        <?php else: ?>
                                                            <p>
                                                                <button class="btn btn-md btn-outline-gray btn-shop"><i class="icon-user-plus"></i><?= trans("follow"); ?></button>
                                                            </p>
                                                        <?php endif; ?>
                                                    </form>
                                                    ...
                                                    <form action="<?= base_url('add-remove-favourite-user-post'); ?>" method="post" class="form-inline">
                                                        <?= csrf_field(); ?>
                                                        <input type="hidden" name="shop_owner_id" value="<?= $shop->id; ?>">
                                                        <input type="hidden" name="favourite_user_id" value="<?= user()->id; ?>">
                                                        <input type="hidden" name="back_url" value="<?= generateUrl('shops'); ?>">
                                                        <?php if (isUserFavourite($shop->id, user()->id)): ?>
                                                            <p>
                                                                <button class="btn btn-md btn-outline-gray btn-shop"><i class="icon-star"></i><?= "-Favorite"; ?></button>
                                                            </p>
                                                        <?php else: ?>
                                                            <p>
                                                                <button class="btn btn-md btn-outline-gray btn-shop"><i class="icon-star"></i><?= "+Favorite" ?></button>
