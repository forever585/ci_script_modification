                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <th class="border-0 font-weight-bold"><?= "Gift Quantity"; ?></th>
                                            <th class="border-0 font-weight-bold"><?= "Gift Fee"; ?></th>
                                            ...
                                            foreach ($invoiceItems as $item):
                                                if (!empty($item['id'])):
                                                    ...
                                                    if (!empty($orderProduct)):
                                                        ...
                                                        if ($showItem == true):
                                                            $saleSubtotal += $orderProduct->product_total_price;
                                                            $saleVat += $orderProduct->product_vat;
                                                            $saleShipping = $orderProduct->seller_shipping_cost;
                                                            $saleTotal += $orderProduct->product_total_gift_contained_price; ?>
                                                            <tr style="font-size: 15px;">
                                                                ...
                                                                <td><?= $orderProduct->gift_quantity; ?></td>
                                                                <td><?= priceFormatted($orderProduct->gift_wrapping_fee, $orderProduct->product_currency); ?></td>
                                                                <?php if ($generalSettings->vat_status): ?>
                                                                ...
                                                                <?php endif; ?>
                                                                <td style="white-space: nowrap"><?= priceFormatted($orderProduct->product_total_gift_contained_price, $orderProduct->product_currency); ?></td>
                                                            </tr>
                                                        <?php endif;
                                                    endif;
                                                endif;
