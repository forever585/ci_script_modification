                    ...
                    <td>
                        ...
                        <div class="mailcontent" style="line-height: 26px;font-size: 14px;">
                            <p style='text-align: left'>
                                <?= trans("name"); ?>:&nbsp;<?= !empty($emailData['messageName']) ? esc($emailData['messageName']) : '' . ','; ?>
                                <?= trans("email_address"); ?>:&nbsp;<?= !empty($emailData['messageEmail']) ? esc($emailData['messageEmail']) : ''; ?>
                                <?= "has sent you a message using the contact us form on Handmade Guild";?>
                                <br><br>
                                <?= "here is their message:";?><br/>
