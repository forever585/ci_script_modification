...
class EarningsController extends BaseAdminController
{
    ...
    public function initController(\CodeIgniter\HTTP\RequestInterface $request, \CodeIgniter\HTTP\ResponseInterface $response, \Psr\Log\LoggerInterface $logger)
    {
        ...
        $this->feeAdminModel = new FeeAdminModel();
    }
    ...
    public function getListingFees(){
        $data['title'] = "Listing Fees";
        $numRows = $this->feeAdminModel->getListingFeesCount();
        $pager = paginate($this->perPage, $numRows);
        $data['listing_fees'] = $this->feeAdminModel->getListingFeesPaginated($this->perPage, $pager->offset);
        echo view('admin/includes/_header', $data);
        echo view('admin/earnings/listing_fees', $data);
        echo view('admin/includes/_footer');
    }
}