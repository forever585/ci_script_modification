...
class AdminController extends BaseAdminController
{
    ...
    */
    ...
    /**
     * Set seller listing fee paid
     */
    public function setSellerListingFeePaid($listingFeeId)
    {
        if (isSuperAdmin()) {
            $feeModel = new FeeModel();
            $authModel = new AuthModel();
            $sellerId = inputGet("seller_id");
            $authModel->increaseListingFee($sellerId) && $feeModel->chargeListingFee($listingFeeId);
        }
        return redirect()->to(adminUrl('/listing-fees'));
    }
}
