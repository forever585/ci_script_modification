...
class CartController extends BaseController
{
    ...
    public function cart()
    {
        ...
        $data['sellerIds'] = $this->cartModel->getSessCartItemSellerIds();
    ...
    public function leaveMessageToSeller(){
        $this->cartModel->addMessageToSeller();
        redirectToBackUrl();
    }

    //delete message from buyer
    public function deleteMessageFromBuyer(){
        $this->cartModel->deleteMessageFromBuyer();
        redirectToBackUrl();
    }
}
