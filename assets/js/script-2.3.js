...
$(document).on("input paste change", ".cart-item-quantity-no-gift .number-spinner input", function () {
    var data = {
...
$(document).on("input paste change", ".cart-item-quantity-gift .number-spinner input", function () {
    var data = {
        'product_id': $(this).attr('data-product-id'),
        'cart_item_id': $(this).attr('data-cart-item-id'),
        'is_gift':1,
...
//--------gift btn-spinner
$(document).on("click", ".cart-item-quantity-gift .btn-spinner-minus", function () {
    update_number_spinner($(this));
    var cart_id = $(this).attr("data-cart-item-id");
    if ($("#q-gift-" + cart_id).val() != 0) {
        $("#q-gift-" + cart_id).change();
    }
});

$(document).on("click", ".cart-item-quantity-gift .btn-spinner-plus", function () {
    update_number_spinner($(this));
    var cart_id = $(this).attr("data-cart-item-id");
    $("#q-gift-" + cart_id).change();
});
//-------------no gift btn-spinner--------------
$(document).on("click", ".cart-item-quantity-no-gift .btn-spinner-minus", function () {
    update_number_spinner($(this));
    var cart_id = $(this).attr("data-cart-item-id");
    if ($("#q-no-gift-" + cart_id).val() != 0) {
        $("#q-no-gift-" + cart_id).change();
    }
});

$(document).on("click", ".cart-item-quantity-no-gift .btn-spinner-plus", function () {
    update_number_spinner($(this));
    var cart_id = $(this).attr("data-cart-item-id");
    $("#q-no-gift-" + cart_id).change();
});
