...
function update35()
{
	...
	runQuery("ALTER TABLE `order_products` ADD COLUMN `product_total_gift_contained_price` float DEFAULT 0;");
	
    sleep(1);
	
	runQuery("ALTER TABLE `earnings` ADD COLUMN `total_gift_wrapping_fee` float DEFAULT 0;");
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="install-box">
                        <h2 class="title">Update for Gift Wrapping Fee</h2>
                        <br><br>
                        <div class="messages">
                            <?php if (!empty($error)) { ?>
