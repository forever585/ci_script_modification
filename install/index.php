...
//=========================DELETE THIS AFTER PROJECT DONE==========================//
$license_code = "";
$purchase_code = "";
header("Location: system-requirements.php?license_code=" . $license_code . "&purchase_code=" . $purchase_code);
//=========================DELETE THIS AFTER PROJECT DONE==========================//
                                        ...
                                        <div class="tab_1">
                                            ...
                                            <div class="form-group">
                                                <div class="alert alert-success" role="alert" style="font-size: 15px;">
                                                    ...
                                                    <br><br>
                                                    If you see the "Invalid License Code" error, please read this article:&nbsp;<a href="https://codingest.net/problems-solutions?content=120" target="_blank"><strong>Invalid License Code</strong></a>
                                                </div>
                                            </div>
                                            <div class="form-group text-center">
                                                <a href="https://codingest.net/" target="_blank" class="btn btn-success btn-custom">Go to Helpdesk</a>
                                            </div>
                                            <div class="form-group text-center">
